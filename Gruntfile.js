...
module.exports = function (grunt) {
  ...
  var jsFilesToInject = [
	...
	'linker/js/Mirror.js',
	'linker/js/WebGLDeferredRenderer.js',
	'linker/js/ShaderDeferred.js',
	'linker/js/BleachBypassShader.js',
	'linker/js/BlendShader.js',
	'linker/js/HorizontalTiltShiftShader.js',
	'linker/js/VerticalTiltShiftShader.js',
	'linker/js/TriangleBlurShader.js',
	'linker/js/VignetteShader.js',
	'linker/js/CopyShader.js',
	'linker/js/FXAAShader.js',
	'linker/js/ConvolutionShader.js',
	'linker/js/EffectComposer.js',
	'linker/js/RenderPass.js',
	'linker/js/ShaderPass.js',
	'linker/js/SavePass.js',
	'linker/js/MaskPass.js',
	'linker/js/BloomPass.js',
	'linker/js/dat.gui.min.js',
	'linker/js/Detector.js',
	'linker/js/stats.min.js',
	'linker/js/BokehShader2.js',
	'linker/js/d3.min.js',
	'linker/js/sankey.js',
	'linker/js/MyOrbitControls.js',
	'linker/js/KeyboardState.js',
	'linker/js/tween.min.js',
	'linker/js/dom.jsPlumb-1.6.2.js',
	'linker/js/cubism.v1.min.js',
	'linker/js/arbor.js',
	'linker/js/cytoscape.min.js',
	//'linker/js/cytoscape.js-panzoom.js',
	//'linker/js/Curry-1.0.1.js',
	//'linker/js/dracula_algorithms.js',
	//'linker/js/dracula_graffle.js',
	//'linker/js/dracula_graph.js',
	//'linker/js/seedrandom.js',
